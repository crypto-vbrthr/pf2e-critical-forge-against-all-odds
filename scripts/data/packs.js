...
import { NARROW_ESCAPE_REFLEX_CARDS } from "./cards/narrow-escape-reflex.js";
import { NARROW_ESCAPE_WILL_CARDS } from "./cards/narrow-escape-will.js";
                            ...
                            : theme.id === THEME_IDS.GIANT_SLAYER && deckType === "will"
                              ...
                              : theme.id === THEME_IDS.NARROW_ESCAPE && deckType === "attack"
                                ...
                                : theme.id === THEME_IDS.NARROW_ESCAPE && deckType === "fortitude"
                                  ...
                                  : theme.id === THEME_IDS.NARROW_ESCAPE && deckType === "reflex"
                                    ? NARROW_ESCAPE_REFLEX_CARDS
                                    : theme.id === THEME_IDS.NARROW_ESCAPE && deckType === "will"
